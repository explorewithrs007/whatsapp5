        ...
        <div className="space-y-5">
          ...
          {contactHistory.length ? (
            groupedHistory.length ? (
                  ...
                  <section key={group.date}>
                    ...
                    <div className="mt-1 divide-y divide-border">
                      {group.items.map((item) => (
                        <div
                          className="grid gap-2 px-1 py-2 text-sm sm:grid-cols-[78px_minmax(0,1fr)_86px_120px_52px] sm:items-center"
                          key={item.id}
                        >
                          ...
                          <p className="truncate text-xs text-muted-foreground">{item.assignedAgent}</p>
              ...
              <EmptyState title="No conversation history found" description="Try changing your search or status filter." />
            )
          ) : (
            <EmptyState
