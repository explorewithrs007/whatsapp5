    ...
    <SectionCard>
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <h2 className="text-base font-semibold text-foreground">API Connection</h2>
            <p className="mt-1 text-sm text-muted-foreground">BSP-managed WhatsApp setup.</p>
        </div>
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        <div className="rounded-xl border border-border bg-slate-50 p-4">
          <p className="text-xs font-semibold uppercase tracking-normal text-muted">Connection Status</p>
          <div className="mt-2">
            <StatusBadge status={whatsappConnection.status} />
          </div>
        </div>
        <div className="rounded-xl border border-border bg-slate-50 p-4">
          <p className="text-xs font-semibold uppercase tracking-normal text-muted">WhatsApp Business Account</p>
          <p className="mt-2 text-sm font-medium text-foreground">{whatsappConnection.businessAccount}</p>
        </div>
        <div className="rounded-xl border border-border bg-slate-50 p-4">
          <p className="text-xs font-semibold uppercase tracking-normal text-muted">Business Phone Number</p>
          <p className="mt-2 text-sm font-medium text-foreground">{whatsappConnection.businessPhoneNumber}</p>
        </div>
        <div className="rounded-xl border border-border bg-slate-50 p-4">
          <p className="text-xs font-semibold uppercase tracking-normal text-muted">Phone Number ID</p>
          <p className="mt-2 text-sm font-medium text-foreground">{whatsappConnection.phoneNumberId}</p>
        </div>
        <div className="rounded-xl border border-border bg-slate-50 p-4">
          <p className="text-xs font-semibold uppercase tracking-normal text-muted">Connection Model</p>
          <p className="mt-2 text-sm font-medium text-foreground">{whatsappConnection.setupType}</p>
        </div>
        <div className="rounded-xl border border-border bg-slate-50 p-4">
          <p className="text-xs font-semibold uppercase tracking-normal text-muted">Last Webhook Received</p>
          <p className="mt-2 text-sm font-medium text-foreground">{whatsappConnection.lastWebhookReceived}</p>
        </div>
      </div>
    </SectionCard>
  );
...
function SendReceiveSection() {
  ...
  return (
    <SectionCard>
      <div className="mb-5">
        <h2 className="text-base font-semibold text-foreground">Send/Receive Messages</h2>
        <p className="mt-1 text-sm text-muted-foreground">Supported WhatsApp message types.</p>
      </div>
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {supportedMessageTypes.map((type, index) => {
          ...
          return (
            <div key={type.label} className="rounded-xl border border-border bg-slate-50 p-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-whatsapp/20 bg-whatsapp-light text-whatsapp-dark">
                <Icon className="h-5 w-5" />
              </div>
              <p className="mt-4 text-sm font-semibold text-foreground">{type.label}</p>
    ...
    <div className="grid gap-4 pb-24">
      <SectionCard>
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-base font-semibold text-foreground">Template Messages</h2>
            <p className="mt-1 text-sm text-muted-foreground">Manage pre-approved WhatsApp templates.</p>
          </div>
  ...
  return (
    <SectionCard>
      <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h2 className="text-base font-semibold text-foreground">Chatbot Triggers</h2>
          <p className="mt-1 text-sm text-muted-foreground">Keyword-based WhatsApp auto-responses.</p>
        </div>
...
function MessageStatusSection() {
  ...
  return (
    <div className="grid gap-4">
      <SectionCard>
        <div className="mb-5">
          <h2 className="text-base font-semibold text-foreground">Message Status</h2>
          <p className="mt-1 text-sm text-muted-foreground">
            Track sent, delivered, and read status.
          </p>
        </div>
        <div className="grid gap-4 md:grid-cols-3">
          {messageStatusOverview.map((item, index) => {
            ...
            return (
              <div key={item.status} className="rounded-xl border border-border bg-slate-50 p-4">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <StatusBadge status={item.status} />
                    <p className="mt-3 text-3xl font-semibold leading-none tracking-normal text-foreground">
                      {item.value}
                    </p>
                    <p className="mt-3 text-sm text-muted-foreground">{item.description}</p>
                  </div>
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-whatsapp/20 bg-whatsapp-light text-whatsapp-dark">
