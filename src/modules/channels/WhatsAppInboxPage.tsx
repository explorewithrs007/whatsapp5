  ...
  return (
    <div className="flex h-full w-full overflow-hidden">
      ...
      <section className="grid min-h-0 flex-1 overflow-hidden bg-card grid-cols-[300px_minmax(0,1fr)_300px] 2xl:grid-cols-[320px_minmax(0,1fr)_320px] min-[1600px]:grid-cols-[340px_minmax(0,1fr)_340px]">
        <section className="flex h-full min-h-0 w-full min-w-0 flex-col overflow-hidden border-r border-border px-1.5 py-2">
          ...
          />
          {isWorkspaceAdmin ? (
            <label className="mt-2 flex items-center justify-between gap-2 px-1">
          ...
          <div className="subtle-scrollbar mt-2 min-h-0 w-full flex-1 overflow-y-auto border-t border-border">
              ...
              filteredByAssignedAgent.map((conversation) => {
                ...
                return (
                  <button
                    key={conversation.id}
                    className={cn(
                      "flex min-h-[58px] w-full items-center gap-2 border-b border-border px-1.5 py-1.5 text-left transition-colors last:border-b-0",
                      isSelected
        ...
        <section className="flex h-full min-h-0 min-w-0 flex-col overflow-hidden">
          <div className="flex min-h-0 flex-1 flex-col">
            ...
            <div ref={messageAreaRef} className="subtle-scrollbar min-h-0 flex-1 space-y-2.5 overflow-y-auto bg-slate-50/60 px-3 pb-3 pt-2.5">
        ...
        <section className="subtle-scrollbar h-full min-h-0 w-full min-w-0 overflow-y-auto border-l border-border px-2 py-2">
    ...
    <div>
      ...
      <div className="mt-3 space-y-2">
        {notes.length ? (
          ...
          <p className="rounded-xl bg-slate-50/70 p-4 text-sm text-muted-foreground">
