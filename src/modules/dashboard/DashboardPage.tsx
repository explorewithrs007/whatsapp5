import { CheckCircle2, Clock3, MessageCircle, MessagesSquare } from "lucide-react";
...
const metricIcons = [MessageCircle, Clock3, CheckCircle2, MessagesSquare];
      ...
      <section className="grid items-stretch gap-4 xl:grid-cols-[minmax(0,1fr)_380px]">
        <SectionCard className="flex h-[min(46vh,440px)] min-h-[360px] flex-col">
          ...
          <div className="subtle-scrollbar min-h-0 flex-1 overflow-y-auto pr-1">
            <DataTable columns={agentColumns} data={agentPerformance} getRowId={(row) => row.agent} />
          </div>
        </SectionCard>
